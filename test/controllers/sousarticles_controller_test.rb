...
class SousarticlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sousarticle" do
    assert_difference("Sousarticle.count") do
      post sousarticles_url, params: { sousarticle: { article_id: @sousarticle.article_id, caution: @sousarticle.caution, description: @sousarticle.description, nature: @sousarticle.nature, prix: @sousarticle.prix, taille: @sousarticle.taille } }
    end
  ...
  test "should update sousarticle" do
    patch sousarticle_url(@sousarticle), params: { sousarticle: { article_id: @sousarticle.article_id, caution: @sousarticle.caution, description: @sousarticle.description, nature: @sousarticle.nature, prix: @sousarticle.prix, taille: @sousarticle.taille } }
