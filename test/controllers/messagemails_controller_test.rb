...
class MessagemailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create messagemail" do
    assert_difference("Messagemail.count") do
      post messagemails_url, params: { messagemail: { body: @messagemail.body, client_id: @messagemail.client_id, commande_id: @messagemail.commande_id, commentaires: @messagemail.commentaires, titre: @messagemail.titre } }
    end
  ...
  test "should update messagemail" do
    patch messagemail_url(@messagemail), params: { messagemail: { body: @messagemail.body, client_id: @messagemail.client_id, commande_id: @messagemail.commande_id, commentaires: @messagemail.commentaires, titre: @messagemail.titre } }
