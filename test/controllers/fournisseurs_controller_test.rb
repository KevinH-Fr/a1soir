...
class FournisseursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fournisseur" do
    assert_difference("Fournisseur.count") do
      post fournisseurs_url, params: { fournisseur: { contact: @fournisseur.contact, mail: @fournisseur.mail, nom: @fournisseur.nom, notes: @fournisseur.notes, site: @fournisseur.site, tel: @fournisseur.tel } }
    end
  ...
  test "should update fournisseur" do
    patch fournisseur_url(@fournisseur), params: { fournisseur: { contact: @fournisseur.contact, mail: @fournisseur.mail, nom: @fournisseur.nom, notes: @fournisseur.notes, site: @fournisseur.site, tel: @fournisseur.tel } }
