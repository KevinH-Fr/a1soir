...
class PaiementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paiement" do
    assert_difference("Paiement.count") do
      post paiements_url, params: { paiement: { commande_id: @paiement.commande_id, montant: @paiement.montant, type: @paiement.type } }
    end
  ...
  test "should update paiement" do
    patch paiement_url(@paiement), params: { paiement: { commande_id: @paiement.commande_id, montant: @paiement.montant, type: @paiement.type } }
